...
const NotFound = () => {
  return (
    <div className="h-screen max-w-4xl mx-auto grid grid-cols-1 lg:max-w-5xl lg:gap-x-20 lg:grid-cols-2">
      <div className="flex items-center justify-center md:order-2">
        <div className="p-3 col-start-1 row-start-1 flex flex-col rounded-lg bg-gradient-to-t from-black/75 via-black/0 sm:bg-none sm:row-start-2 sm:p-0 lg:row-start-1">
          <h1 className="mt-1 mb-5 text-4xl lg:text-9xl font-semibold text-white  md:text-5xl  text-center">
            404
          </h1>
          <h2 className=" text-2xl mb-5 md:text-3xl lg:text-4xl leading-4 font-medium ">
            UH OH! You're lost.
          </h2>
          <p className="mb-5 text-xl md:text-xl lg:text-1xl md:leading-6 lg:leading-8 ">
            The page you are looking for does not exist. How you got here is a
            mystery. But you can click the button below to go back to the
            homepage.
          </p>
          <Link to="/home" className="btn btn-outline btn-success">
            <svg
      ...
      <div className="flex items-center justify-center md:order-1">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 800 600">
          ...
          <g
            ...
            strokeMiterlimit="10"
          >
            <path d="M518.07 245.375v21.206M508.129 255.978h19.881M154.55 231.391v21.207M144.609 241.995h19.881M320.135 132.746v21.206M310.194 143.349h19.881M200.67 483.11v21.206M210.611 493.713H190.73"></path>
          </g>
          <g
            fill="none"
            stroke="#0E0620"
            ...
            strokeMiterlimit="10"
          >
            <path d="M432.173 380.52v11.31M426.871 386.175h10.603M489.555 299.765v8.359M485.636 303.945h7.837M231.468 291.009v8.36M227.55 295.189h7.837M244.032 547.539v8.359M247.95 551.719h-7.837M186.359 406.967v8.359M190.277 411.146h-7.837M480.296 406.967v8.359M484.215 411.146h-7.837"></path>
          </g>
          <g
            fill="none"
            stroke="#0E0620"
          ...
          <g clipPath="url(cordClip)">
            ...
            <g
              ...
              strokeMiterlimit="10"
            >
              <path d="m323.396 236.625-28.111 117.128"></path>
            ...
            >
              ...
              <path d="M388.762 434.677c5.234-3.039 7.731-8.966 6.678-14.594a15.804 15.804 0 0 1 5.837 5.793c4.411 7.596 1.829 17.33-5.767 21.741-7.596 4.411-17.33 1.829-21.741-5.767-1.754-3.021-2.817-5.818-2.484-9.046 4.34 4.551 11.802 5.169 17.477 1.873z"></path>
            </g>
            <g
              //   fill="#FFF"
              stroke="#0E0620"
            ...
            >
              ...
              <path d="M241.978 395.324c-3.012-5.25-2.209-11.631 1.518-15.977a15.821 15.821 0 0 0-7.952 2.096c-7.619 4.371-10.253 14.09-5.883 21.71 4.371 7.619 14.09 10.253 21.709 5.883 3.03-1.738 5.35-3.628 6.676-6.59-6.033 1.768-12.803-1.429-16.068-7.122z"></path>
            </g>
            <g
              stroke="#0E0620"
              strokeWidth="3"
            ...
            >
              ...
              ></path>
              <path fill="none" d="m304.883 486.849 25.604 6.864"></path>
              <path
                // fill="#FFF"
              ...
              ></path>
              <path fill="none" d="m262.638 475.522 25.603 6.865"></path>
            </g>
            <ellipse
